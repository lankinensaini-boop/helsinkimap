...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 15, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:3067',
            //extent: [341658.719000, 6631327.512154, 419548.429000, 6746389.452000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([341658.719000, 6631327.512154, 419548.429000, 6746389.452000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ecological Connectivity: Tree Canopy and Flying Squirrel Habitats</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (251 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows flying squirrel habitats in Helsinki by filtering data to focus only on trees between 15 and 20 meters high. By combining these specific tree heights with wildlife, the layout illustrates how both elements are distributed and intersect.';
            }
